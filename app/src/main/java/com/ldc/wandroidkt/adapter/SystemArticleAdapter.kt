...
class SystemArticleAdapter :
    ...
    BaseQuickAdapter<SystemArticleModel.Data, BaseViewHolder>(R.layout.layout_item_article_image) {

    val TAG: String = SystemArticleAdapter::class.java.name

    override fun convert(helper: BaseViewHolder, item: SystemArticleModel.Data) {
        item ?: return
        //描述
